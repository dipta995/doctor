...
$login = $sc->Logindoctor($_POST,$redirect_link);
...
<span style="color:red; font-weight: 200px;">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="od_email" placeholder="Email">
						 
					</div><br>

					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="od_pass" placeholder="Password">
