            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section_tittle text-center">
                        ...
                        <p>Click and check bellow To Get appoinment with our Specieliest</p>
                    </div>
                </div>
            </div>
             <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                              <a href="doctor.php?doctorid=<?php echo  $row['od_id']; ?>#appointment">
                                <img style="height: 180px; width: 160px;" src="<?php echo $row['od_image'];?>" alt="doctor"> 
                                  </a>
                        ...
                        <div class="single_text">
                            <div class="single_blog_text">    
                                ...
                                <p><?php echo $row['od_dept'];?></p>
                                <a href="single-dr.php?doctorid=<?php echo $row['od_id'];?>#appointment">Check</a>
